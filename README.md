...
![HIPRT path tracer cover](data/img/hiprt_p1.jpg)
![HIPRT path tracer cover](data/img/hiprt_dragon_glass.jpg)
...
![canny edge detection](data/img/canny_edge.jpg)
...
![C++ path tracer cover](data/img/rendu_PBRT_Dragon.jpg)
Implemented features:
- Direct lighting
- Indirect lighting
...
- Skyspheres support
![normal mapping, parallax mapping, rough reflexions, skysphere](data/img/sphere_rose.jpeg)
...
- Hair modelisation
![hair demo](data/img/cheveux.jpg)
...
![sudoku global thresholding](data/img/threshold_global.jpg)
...
![sudoku local thresholding](data/img/threshold_local.jpg)
...
![hough transform](data/img/hough.jpg)
From left to right:
...
- Mirror materials
- Diffuse materials
![ray tracer L2](data/img/RTL2.jpg)
